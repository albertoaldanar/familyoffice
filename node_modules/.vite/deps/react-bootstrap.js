...
function useCallbackRef() {
  return (0, import_react12.useState)(null);
}
...
var SelectableContext = React42.createContext(null);
...
var NavContext = React43.createContext(null);
...
function useDropdownItem({
  ...
  const navContext = (0, import_react36.useContext)(NavContext_default);
  const {
    activeKey
  } = navContext || {};
...
var Context = (0, import_react37.createContext)(canUseDOM_default ? window : void 0);
var WindowProvider = Context.Provider;
function useWindow() {
  return (0, import_react37.useContext)(Context);
}
...
function useRefWithUpdate() {
  ...
  const attachRef = (0, import_react38.useCallback)((element) => {
    ref.current = element;
    forceUpdate();
  }, [forceUpdate]);
...
function Dropdown({
  ...
  const lastSourceEvent = (0, import_react38.useRef)(null);
  const focusInDropdown = (0, import_react38.useRef)(false);
  const onSelectCtx = (0, import_react38.useContext)(SelectableContext_default);
  const toggle = (0, import_react38.useCallback)((nextShow, event, source = event == null ? void 0 : event.type) => {
    onToggle(nextShow, {
      originalEvent: event,
      source
    });
  ...
  useEventListener((0, import_react38.useCallback)(() => window2.document, [window2]), "keydown", (event) => {
...
var DropdownContext = React46.createContext({});
...
var FormLabel = React68.forwardRef(({
  ...
  htmlFor = htmlFor || controlId;
  if (column)
    return (0, import_jsx_runtime65.jsx)(Col_default, {
      ref,
      as: "label",
      className: classes,
      htmlFor,
...
var Switch = React72.forwardRef((props, ref) => (0, import_jsx_runtime69.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
function getReactVersion() {
  const parts = React82.version.split(".");
  return {
    major: +parts[0],
    minor: +parts[1],
    patch: +parts[2]
...
function useRTGTransitionProps(_ref) {
  ...
  return Object.assign({}, props, {
    ...
    ) : (0, import_react54.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
var RTGTransition = React83.forwardRef((_ref, ref) => {
  let {
...
function ImperativeTransition({
  ...
  const combinedRef = useMergedRefs_default(ref, children.ref);
  return exited && !inProp ? null : (0, import_react55.cloneElement)(children, {
    ref: combinedRef
  });
}
...
var Modal = (0, import_react56.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
  ...
  return (0, import_jsx_runtime81.jsx)(import_jsx_runtime82.Fragment, {
    children: import_react_dom2.default.createPortal((0, import_jsx_runtime83.jsxs)(import_jsx_runtime82.Fragment, {
...
var AbstractModalHeader = React90.forwardRef(({
  ...
  const context6 = (0, import_react57.useContext)(ModalContext_default);
...
var Modal2 = React93.forwardRef(({
  ...
  const renderBackdrop = (0, import_react58.useCallback)((backdropProps) => (0, import_jsx_runtime91.jsx)("div", {
    ...backdropProps,
...
var Offcanvas = React104.forwardRef(({
  ...
  const renderBackdrop = (0, import_react64.useCallback)((backdropProps) => (0, import_jsx_runtime102.jsx)("div", {
    ...backdropProps,
...
function useOverlayOffset(customOffset) {
  ...
  const offset = (0, import_react69.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime119.jsxs)(import_jsx_runtime118.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react71.cloneElement)(children, triggerProps), (0, import_jsx_runtime117.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var ToastFade = React133.forwardRef((props, ref) => (0, import_jsx_runtime139.jsx)(Fade_default, {
  ...props,
  ref,
