...
function validateSetOptions(methodName, options) {
  ...
  if (options.mergeFields !== void 0 && options.merge !== void 0) {
    throw new U2("invalid-argument", `Invalid options passed to function ${methodName}(): You cannot specify both "merge" and "mergeFields".`);
  }
  return options;
}
function assertUint8ArrayAvailable() {
  if (typeof Uint8Array === "undefined") {
    throw new U2("unimplemented", "Uint8Arrays are not available in this environment.");
  }
}
function assertBase64Available() {
  if (!be2()) {
    throw new U2("unimplemented", "Blobs are unavailable in Firestore in this environment.");
  }
}
var Blob = class _Blob {
  ...
  static fromBase64String(base64) {
    ...
    return new _Blob(Uh.fromBase64String(base64));
  }
  static fromUint8Array(array) {
    assertUint8ArrayAvailable();
    return new _Blob(Uh.fromUint8Array(array));
  }
  toBase64() {
    assertBase64Available();
...
var Firestore = class {
  ...
  settings(settingsLiteral) {
    ...
    if (!settingsLiteral.merge && currentSettings.host !== settingsLiteral.host) {
      M2("You are overriding the original host. If you did not intend to override your settings, use {merge: true}.");
    }
  ...
  get app() {
    if (!this._appCompat) {
      throw new U2("failed-precondition", "Firestore was not initialized using the Firebase SDK. 'app' is not available");
    }
...
var UserDataWriter = class extends Wl {
  constructor(firestore) {
    super();
    this.firestore = firestore;
  }
  convertBytes(bytes) {
    return new Blob(new Uh(bytes));
  }
...
var Transaction = class {
  ...
  get(documentRef) {
    ...
    return this._delegate.get(ref).then((result) => new DocumentSnapshot(this._firestore, new sf(this._firestore._delegate, this._userDataWriter, result._key, result._document, result.metadata, ref.converter)));
  }
...
var DocumentReference = class _DocumentReference {
  ...
  static forPath(path, firestore, converter) {
    if (path.length % 2 !== 0) {
      throw new U2("invalid-argument", `Invalid document reference. Document references must have an even number of segments, but ${path.canonicalString()} has ${path.length}`);
    }
    return new _DocumentReference(firestore, new fh(firestore._delegate, converter, new ht(path)));
  }
  static forKey(key, firestore, converter) {
    return new _DocumentReference(firestore, new fh(firestore._delegate, converter, key));
  }
  get id() {
...
var QueryDocumentSnapshot = class extends DocumentSnapshot {
  data(options) {
    ...
    B2(data !== void 0, "Document in a QueryDocumentSnapshot should exist");
    return data;
  }
};
var Query = class _Query {
  ...
  where(fieldPath, opStr, value) {
    try {
      return new _Query(this.firestore, Rl(this._delegate, bl(fieldPath, opStr, value)));
    } catch (e) {
  ...
  orderBy(fieldPath, directionStr) {
    try {
      return new _Query(this.firestore, Rl(this._delegate, xl(fieldPath, directionStr)));
    } catch (e) {
      throw replaceFunctionName(e, /(orderBy|where)\(\)/, "Query.$1()");
    }
  }
  limit(n) {
    try {
      return new _Query(this.firestore, Rl(this._delegate, kl(n)));
    } catch (e) {
  ...
  limitToLast(n) {
    try {
      return new _Query(this.firestore, Rl(this._delegate, Ml(n)));
    } catch (e) {
  ...
  startAt(...args) {
    try {
      return new _Query(this.firestore, Rl(this._delegate, Ol(...args)));
    } catch (e) {
  ...
  startAfter(...args) {
    try {
      return new _Query(this.firestore, Rl(this._delegate, Fl(...args)));
    } catch (e) {
  ...
  endBefore(...args) {
    try {
      return new _Query(this.firestore, Rl(this._delegate, Ll(...args)));
    } catch (e) {
  ...
  endAt(...args) {
    try {
      return new _Query(this.firestore, Rl(this._delegate, ql(...args)));
    } catch (e) {
...
var FieldPath = class _FieldPath {
  ...
  static documentId() {
    return new _FieldPath(at.keyField().canonicalString());
  }
  isEqual(other) {
    other = getModularInstance(other);
