...
var g = async ({ elementReference: e2 = null, tooltipReference: t2 = null, tooltipArrowReference: o2 = null, place: r2 = "top", offset: l2 = 10, strategy: n2 = "absolute", middlewares: c2 = [offset(Number(l2)), flip({ fallbackAxisSideDirection: "start" }), shift({ padding: 5 })], border: i2 }) => {
  if (!e2)
...
var D = ({ forwardRef: t2, id: r2, className: c2, classNameArrow: i2, variant: u = "dark", anchorId: d, anchorSelect: p, place: v = "top", offset: m = 10, events: h2 = ["hover"], openOnClick: w2 = false, positionStrategy: b2 = "absolute", middlewares: S2, wrapper: E2, delayShow: A2 = 0, delayHide: O2 = 0, float: k2 = false, hidden: R2 = false, noArrow: x2 = false, clickable: N2 = false, closeOnEsc: $2 = false, closeOnScroll: j2 = false, closeOnResize: D2 = false, openEvents: q2, closeEvents: H2, globalCloseEvents: M, imperativeModeOnly: W, style: P, position: V, afterShow: F, afterHide: K, content: U, contentWrapperRef: X, isOpen: Y, defaultIsOpen: G = false, setIsOpen: Z, activeAnchor: J, setActiveAnchor: Q, border: ee, opacity: te, arrowColor: oe, role: re = "tooltip" }) => {
  ...
  const Ne = (e2) => {
    ...
    A2 ? $e() : xe(true), Q(o2), Ee({ current: o2 }), se.current && clearTimeout(se.current);
  }, Be = () => {
    ...
    g({ place: null !== (o2 = null == ye ? void 0 : ye.place) && void 0 !== o2 ? o2 : v, offset: m, elementReference: r3, tooltipReference: ne.current, tooltipArrowReference: ce.current, strategy: b2, middlewares: S2, border: ee }).then((e3) => {
      Ne(e3);
    });
  }, De = (e2) => {
    if (!e2)
    ...
    o2 ? ze(o2) : k2 ? be.current && ze(be.current) : (null == J ? void 0 : J.isConnected) && g({ place: null !== (t3 = null == ye ? void 0 : ye.place) && void 0 !== t3 ? t3 : v, offset: m, elementReference: J, tooltipReference: ne.current, tooltipArrowReference: ce.current, strategy: b2, middlewares: S2, border: ee }).then((e3) => {
      Oe.current && Ne(e3);
    });
  ...
  }, activeAnchor: J, place: ue.place, isOpen: Boolean(me && !R2 && Fe && Ke) })), me && !R2 && Fe ? import_react.default.createElement(E2, { id: r2, role: re, className: (0, import_classnames.default)("react-tooltip", B.tooltip, z.tooltip, z[u], c2, `react-tooltip__place-${ue.place}`, B[Ke ? "show" : "closing"], Ke ? "react-tooltip__show" : "react-tooltip__closing", "fixed" === b2 && B.fixed, N2 && B.clickable), onTransitionEnd: (e2) => {
    ae.current && clearTimeout(ae.current), pe || "opacity" !== e2.propertyName || (fe(false), he(null), null == K || K());
  }, style: { ...P, ...ue.tooltipStyles, opacity: void 0 !== te && Ke ? te : void 0 }, ref: ne }, Fe, import_react.default.createElement(E2, { className: (0, import_classnames.default)("react-tooltip-arrow", B.arrow, z.arrow, i2, x2 && B.noArrow), style: { ...ue.tooltipArrowStyles, background: oe ? `linear-gradient(to right bottom, transparent 50%, ${oe} 50%)` : void 0 }, ref: ce })) : null;
};
var q = ({ content: t2 }) => import_react.default.createElement("span", { dangerouslySetInnerHTML: { __html: t2 } });
var H = import_react.default.forwardRef(({ id: t2, anchorId: r2, anchorSelect: n2, content: c2, html: i2, render: a2, className: u, classNameArrow: d, variant: p = "dark", place: v = "top", offset: m = 10, wrapper: f = "div", children: h2 = null, events: w2 = ["hover"], openOnClick: b2 = false, positionStrategy: S2 = "absolute", middlewares: E2, delayShow: g2 = 0, delayHide: _2 = 0, float: O2 = false, hidden: T2 = false, noArrow: k2 = false, clickable: C2 = false, closeOnEsc: L2 = false, closeOnScroll: R2 = false, closeOnResize: x2 = false, openEvents: N2, closeEvents: $2, globalCloseEvents: j2, imperativeModeOnly: B2 = false, style: z2, position: H2, isOpen: M, defaultIsOpen: W = false, disableStyleInjection: P = false, border: V, opacity: F, arrowColor: K, setIsOpen: U, afterShow: X, afterHide: Y, role: G = "tooltip" }, Z) => {
  const [J, Q] = (0, import_react.useState)(c2), [ee, te] = (0, import_react.useState)(i2), [oe, re] = (0, import_react.useState)(v), [le, ne] = (0, import_react.useState)(p), [ce, ie] = (0, import_react.useState)(m), [se, ae] = (0, import_react.useState)(g2), [ue, de] = (0, import_react.useState)(_2), [pe, ve] = (0, import_react.useState)(O2), [me, fe] = (0, import_react.useState)(T2), [ye, he] = (0, import_react.useState)(f), [we, be] = (0, import_react.useState)(w2), [Se, Ee] = (0, import_react.useState)(S2), [ge, Ae] = (0, import_react.useState)(null), [_e, Oe] = (0, import_react.useState)(null), Te = (0, import_react.useRef)(P), { anchorRefs: ke, activeAnchor: Ce } = I(t2), Le = (e2) => null == e2 ? void 0 : e2.getAttributeNames().reduce((t3, o2) => {
    var r3;
  ...
  (0, import_react.useEffect)(() => {
    ...
    const o2 = new Set(ke);
    let l2 = n2;
    if (!l2 && t2 && (l2 = `[data-tooltip-id='${t2}']`), l2)
      try {
