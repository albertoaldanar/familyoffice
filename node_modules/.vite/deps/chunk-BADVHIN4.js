...
function Carousel({ carousel }) {
  ...
  if (hasSlides(slides)) {
    for (let i = currentIndex - preload; i < currentIndex; i += 1) {
      ...
      items.push(!carousel.finite || i >= 0 ? React.createElement(CarouselSlide, { key, slide: slides[(i + preload * slides.length) % slides.length], offset: i - currentIndex }) : React.createElement(Placeholder, { key }));
    }
    items.push(React.createElement(CarouselSlide, { key: globalIndex, slide: slides[currentIndex], offset: 0 }));
    for (let i = currentIndex + 1; i <= currentIndex + preload; i += 1) {
      const key = globalIndex + i - currentIndex;
      items.push(!carousel.finite || i <= slides.length - 1 ? React.createElement(CarouselSlide, { key, slide: slides[i % slides.length], offset: i - currentIndex }) : React.createElement(Placeholder, { key }));
    }
  }
...
//# sourceMappingURL=chunk-BADVHIN4.js.map
