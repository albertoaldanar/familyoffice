  ...
  const data = [
    {
      ...
      text1:' Head phones Kit',
      text2:'#23678',
       date: " October 12,2021"  ,
       time:'08:46AM',
       badge: "Shopping",
       location:"Collective Electronic",
       city:'United states of America',
       quantity:"14",
       price: "$368.00",
       status: "badge bg-warning-transparent text-warning fw-semibold",
       rating:"4.0" 
     },
     {
      ...
      text2:'#23646',
       ...
       time:'10:06AM',
       badge: "Success",
       location:"Collective Sprots",
       city:' Los Angels,New York',
       quantity: "24",
       price: "$68.00",
       status: "badge bg-success-transparent text-success fw-semibold",
   rating:"4.0" 
     },
     {
      src:imagesData('product11') ,
      text1:' Ear phones 3D kit',
      text2:'#445620',
   ...
   rating:"4.0" 
     },
     {
      ...
      text2:'#23678',
       ...
       quantity:"08",
       price: "$468.00",
       status: "badge bg-primary-transparent text-primary fw-semibold",
   rating:"4.0" 
     },
     {
      ...
      text2:'#23678',
       ...
       time:'04:04PM',
       badge: "Confirmed",
       location:"Home Decores",
       city:' Los Angels,New York',
       quantity:"10",
       price: "$268.00",
       status: "badge bg-danger-transparent text-danger fw-semibold",
   rating:"4.0" 
     }
  ]
  ...
  const columns = [
    {
      ...
      <span className="avatar avatar-md me-3"><img alt="product-image" className=" cover-image br-7" src={row.src} /></span>
      <div className="flex-1">
        <h6 className="mb-0 mt-1 text-dark fw-semibold">
        {row.text1}
        </h6>
        <span className="text-muted fw-semibold fs-12">{row.text2}</span>
      </div>
      </div>
    },
    {
      ...
      sortable: true,
      cell: row => <div>
      <p className="text-muted mb-0 fs-12 fw-semibold">{row.time}</p>
      <h6 className="mb-0 mt-1 text-dark fw-semibold">
      {row.date}
      </h6>
      </div>
    },
    {
      ...
      cell: row =>
      <div>
      <span className={row.status}>{row.badge}
      </span>
      </div>
    },
    {
...
<span className="text-muted fs-12 fw-semibold">{row.city}
</span>
</div>
    ...
    },
    {
      ...
      sortable: false,
      cell: row => 
      <div className="text-dark fs-13 fw-semibold">  {row.quantity}</div>
   ...
   
    {
      ...
      sortable: true,
      cell: row =>
      <div className="text-dark fw-semibold fs-13 mb-0">  {row.price}</div>
    },
     {
      name: "RATING",
      sortable: false,
      cell: row =>  <div className="d-flex align-items-center border-bottom-0">
      <div>
        <Link to="#"><i className="fa fa-star text-warning fs-12"></i></Link>
        <Link to="#"><i className="fa fa-star text-warning fs-12"></i></Link>
        <Link to="#"><i className="fa fa-star text-warning fs-12"></i></Link>
        <Link to="#"><i className="fa fa-star text-warning fs-12"></i></Link>
        <Link to="#"><i className="fa fa-star-o text-warning fs-12"></i></Link>
      </div>
      <span className="text-muted fs-12 ms-1">{row.rating}</span>
      </div>
    },
