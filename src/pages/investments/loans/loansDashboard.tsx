    ...
    return (
      <div style={{ marginLeft: 20, marginRight: 20 }}>
        ...
        <Row style={{ marginTop: 20, marginBottom: 30 }}>
          ...
          <ReactApexChart
            options={{
              ...
              plotOptions: {bar: { horizontal: false, distributed: true, borderRadius: 6 }}
            }}
          ...
          <Col lg={4}>
            <div style={{ padding: 10 }}>
              <p style={{ marginBottom: 20 }}>
                Distribución por acreedor en {currency}
              </p>
              <ReactApexChart
        ...
        <Row style={{ marginTop: 20, marginBottom: 50 }}>
          <Col lg={4}>
            <div style={{ padding: 10 }}>
              <p style={{ marginBottom: 20 }}>Distribución # de prestamos por país</p>
              <ReactApexChart
                options={{ ...chartOptionCleanValue, labels: byCountry.labels }}
